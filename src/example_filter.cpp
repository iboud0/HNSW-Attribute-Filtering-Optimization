...
int main() {
    ...
    int k = 10;
    int total_queries = 0; // Counter for successfully filtered queries
    for (int i = 0; i < max_elements; i++) {
    ...
    // Print confirmation of successful filtering
    std::cout << "Filtering completed for " << total_queries << " queries with no errors.\n";
